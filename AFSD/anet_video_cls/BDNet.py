...
class CoarsePyramid(nn.Module):
    def __init__(self, model_cfg, feat_channels=(832, 1024), frame_num=768): 
        ...
        self.loc_proposal_branch = ProposalBranch(out_channels, 768) 
        self.conf_proposal_branch = ProposalBranch(out_channels, 768) 
    ...
    def forward(self, backbone_feat, ssl=False):
        ...
        start_feat = frame_level_feat[:, :384] 
        end_feat = frame_level_feat[:, 384:]  
